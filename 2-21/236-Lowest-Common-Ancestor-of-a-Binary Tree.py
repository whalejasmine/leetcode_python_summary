#Method 1 Iterative using parent pointers
#Time O(n) worst case traverse all nodes in binary tree
#Space O(n) save all nodes
...
#Method 2 Iterative without parent pointers
#Time O(n) worst case traverse all nodes in binary ;
